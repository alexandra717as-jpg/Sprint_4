...
class TestBooksCollector:
    ...
    def test_get_books_for_children_allowed_genres(self):
        collector = BooksCollector()
    ...
    def test_get_books_for_children_horror_not_allowed(self):
        collector = BooksCollector()
    ...
    def test_add_book_in_favorites_not_in_list_not_added(self):
        collector = BooksCollector()
    ...
    def test_set_genre_for_different_books(self, name, genre):
        collector = BooksCollector()
